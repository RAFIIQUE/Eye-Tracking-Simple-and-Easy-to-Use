...
threshold =  .02  # Adjusted eye movement threshold
...
# Socket setup
HOST = '192.168.137.14'  # The Raspberry Pi's IP address
    ...
    if (current_time - prev_time) >= (1 / fps):
        if landmark_points:
                ...
                if mode == "PROMPT_DIRECTION":
                    ...
                    if current_time >= next_check_time:
                        ...
                        if direction_detected:
                            ...
                            print(f"Sending move {direction_detected.lower()} command.")
                            client_socket.sendall(direction_detected.encode())  # Send the detected direction to the Raspberry Pi
                            mode = "MOVING_CURSOR"
            ...
            if eye_distance < 0.01 and current_time - last_click_time > cooldown:
                ...
                # Send click command to Pi
                client_socket.sendall("Click".encode())
